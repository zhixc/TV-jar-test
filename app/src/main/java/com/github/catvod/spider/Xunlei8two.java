 ...
 * 迅雷电影天堂、迅雷吧
 */
public class Xunlei8two extends Spider {
    ...
    public static void main(String[] args) {
        Xunlei8two xunlei8two = new Xunlei8two();
        try {
//            xunlei8two.init(new Context(), "https://raw.githubusercontent.com/zhixc/CatVodSpider/refs/heads/dev/json/xunlei8.json");
            xunlei8two.init(new Context(), "https://fastly.jsdelivr.net/gh/zhixc/CatVodSpider@refs/heads/dev/json/xunlei8.json");
//            SpiderDebug.log(xunlei8two.homeContent(true));
            HashMap<String, String> extend = new HashMap<>();
            SpiderDebug.log(xunlei8two.categoryContent("tv", "1", true, extend));
        } catch (Exception e) {
